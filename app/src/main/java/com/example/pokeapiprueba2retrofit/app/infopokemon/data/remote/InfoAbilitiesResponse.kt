...
data class InfoAbilitiesResponse(
    @SerializedName("effect_changes") val effectChanges: Any?,
    @SerializedName("effect_entries") val effectEntries: List<AbilityEffectEntriesResponse>,
    @SerializedName("flavor_text_entries") val flavorTextEntries: List<AbilityFlavorTextEntriesResponse> = listOf(),
    ...
    @SerializedName("names") val names: List<AbilityNamesResponse> = arrayListOf(),
